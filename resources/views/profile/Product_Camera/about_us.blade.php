...
<body class="bg-gradient-to-r from-green-600 to-white p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="md:order-1 text-white bold">
                <p class="text-lg mb-4">
                    ...
                    website ini juga bisa menjadi pijakan untuk anda yang ingin memulai karir sebagai Photografer lohh,
                    tunggu apa lagi buruan checkout camera nya sebelum kehabisan!!!.</p>
            </div>
        </div>
    </div>
    <footer class="rounded bg-green-900 lg:grid lg:grid-cols-5">
                ...
                <div class="mt-12 border-t border-gray-100 pt-12">
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <ul class="flex flex-wrap gap-4 text-xs">
                            <li>
                                <a href="#" class="text-white transition hover:opacity-75"> Terms & Conditions
                                </a>
                            </li>
